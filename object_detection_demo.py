...
if __name__ == "__main__":
    ...
    # model_path = r'ssd_mobilenet_v1_coco_2018_01_28\frozen_inference_graph.pb'

    odapi = DetectorAPI(path_to_ckpt=model_path)
    threshold = 0.7

    # ------------------------ Detection from image ------------------------
    image_url = r'https://cdn.pixabay.com/photo/2017/01/14/10/56/people-1979261_960_720.jpg'
